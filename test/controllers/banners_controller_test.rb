...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { alt_text: @banner.alt_text, image: @banner.image } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { alt_text: @banner.alt_text, image: @banner.image } }
